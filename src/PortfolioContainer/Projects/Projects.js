        ...
        <img src={divider}
         className="divider2" width={('49%')} alt=""/>
            ...
            <div className="project-parent">                
               ...
               <a href="https://crypto-app-six-pi.vercel.app/"  target="_blank">
               <button className="live-btn">Live</button></a>

              <a href=" https://github.com/Owolusi/Crypto-app" target="_blank">
            ...
            <div className="col-md-6 col-lg-3">
               ...
               <h3 className="card-title mb-3">Fashion Learning Website</h3>
                ...
                <a href="https://github.com/Owolusi/Fahion-designer-website" target="_blank">
                     <button className="code-btn">Code</button>
                     </a>
